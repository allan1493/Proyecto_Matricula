<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerMateria.aspx.cs" Inherits="ProyectoFinal.VerMateria" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Información Materia </title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td colspan="2" class="h1Prin"><h3>Información Materia</h3></td>
                </tr>
                <tr>
            ...
            <tr>
                 <td>
                     <asp:Button ID="btnVerMateria" runat="server" Text="Ver Materia" OnClick="VerMateria_Click" /></td>
